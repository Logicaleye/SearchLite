...
SearchLite supports exact phrase queries using a positional inverted index.

Example:
"machine learning"

Phrase search verifies that the query terms occur consecutively and in the correct order.

For example:
"machine learning"

will match a document containing:
